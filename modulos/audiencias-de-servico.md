...
Cada linha desta lista é um **serviço da casa que aceita token de acesso** — hoje, só o V3RSigner, mas a tela já nasce pronta para o próximo. Cadastrar aqui não emite nenhum token sozinho: é o **produto**, em **[Produtos](/modulos/produtos/)**, que se liga a uma audiência para que emitir esse produto passe a emitir token junto — chamado, a partir daí, de **acesso**, não mais de licença (veja **[Licenças e acessos](/modulos/licencas/#licença-ou-acesso--a-mesma-tela-dois-vocabulários)**). Produto sem audiência ligada (a imensa maioria) nunca gera token — nada muda para ele.
...
**Rótulo** — o nome de exibição, o que aparece nesta lista e na coluna "Token de acesso" de **[Licenças e acessos](/modulos/licencas/)**.
