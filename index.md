...
{: .note }
> **Versão instalada:** `v0.7.1`. Este manual descreve o que existe **hoje** — a integração com WooCommerce e um dashboard de métricas de negócio ainda não foram construídos; quando existirem, este manual é atualizado.
