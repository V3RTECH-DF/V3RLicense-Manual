...
Uma página por tarefa do dia a dia de quem opera o V3RLicense. Cada página explica o passo a passo, um exemplo com dados plausíveis, o que pode dar errado e o que fazer quando der.

## Cadastro-base (uma vez, ou raramente)

- **[Registrar um plugin novo](/processos/cadastrar-produto/)**
- **[Vender um plugin por assinatura](/processos/vender-por-assinatura/)** — o caminho mais comum
...
- **[Liberar uma ativação](/processos/liberar-ativacao/)**

## Publicação de versão

- **[Gerenciar tokens de publicação](/processos/gerenciar-tokens-publicacao/)**
- **[Publicar uma versão](/processos/publicar-uma-versao/)**
- **[Remover um release publicado](/processos/remover-release/)**

## Quando algo dá errado

- **[Diagnóstico: cliente diz que não atualiza](/processos/diagnostico-sem-atualizacao/)**
